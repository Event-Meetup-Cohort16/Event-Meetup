...
export default class CommentBox extends React.Component {
  ...
  componentDidMount() {
    ...
    let user = this.props.userEmail.replace(/\./g, ',')
    let eventID = this.props.searchResults[0].id
  ...
  render(){
    return(
      <div className="commentBox__div" >
        ...
        <CommentForm eventID={this.state.eventID} host={this.state.host} onCommentSubmit={this.handleCommentSubmit} submitForm={this.addComments} user={this.props.userEmail} />
